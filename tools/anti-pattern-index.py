...
SITUATIONS = [
    ("report something DONE / write a wrap-up",
     ["12", "29", "30", "38", "45", "50", "56", "57", "62", "64", "67", "68", "69"]),
    ("count, enumerate, or declare a defect class closed",
     ["68", "54", "42", "29", "65"]),
    ("record a ruling or decision Matt just made",
     ["69", "63", "18", "56"]),
    ("hit an obstacle while building something Matt already ruled on",
     ["74", "23a", "26", "69"]),
    ("ask Matt a question / write \"this is still yours to rule on\"",
     ["74", "69", "63", "55"]),
    ("add a config setting, toggle or column",
     ["70", "46", "33", "44"]),
    ...
    ("build a monitor, detector, gate or coverage check",
     ["67", "38", "61", "65", "35", "36", "13b", "71"]),
    ("cite a passing or mutation-tested test as evidence a DECISION is right",
     ["71", "29", "23a", "26"]),
    ("write a test pinning an internal invariant — a count, a denominator, a byte hash",
     ["71", "46", "68", "65"]),
